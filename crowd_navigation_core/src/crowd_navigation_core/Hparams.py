...
class Hparams:
    ...
    if world_type == WorldType.EMPTY:
        ...
        viapoints = {
            ...
            (1, 0): np.array([0.2, -1.1]),
            (1, 2): np.array([-2.5, -1.0]),
            (2, 1): np.array([-2.5, -1.0]),
            (1, 8): np.array([-2.5, -1.0]),
            (8, 1): np.array([-2.5, -1.0]),
            (2, 8): np.array([-2.5, -1.0]),
            (8, 2): np.array([-2.5, -1.0]),
        ...
        area1 = np.array([[-0.1, 0.6], [-0.5, -1.0], [7.2, -3.2], [7.8, -1.4]])
        area2 = np.array([[6.6, 5.0], [4.6, -2.5], [7.2, -3.2], [9.5, 4.3]])
        area3 = np.array([[1, 4.4], [0.2, 1.8], [9.5, -0.9], [10.5, 1.4]])
