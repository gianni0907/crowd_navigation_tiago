...
class ControllerManager:
    ...
    def publish_command(self):
        ...
        if self.status == Status.MOVING:
            ...
            print(f'driving acc: {v_dot}')
            print(f'steering acc: {omega_dot}')
            print(f'driving vel: {v}')
            print(f'steering vel: {omega}')
        else:
            v = 0.0
            omega = 0.0
    ...
    def joint_states_callback(self, msg):
        self.wheels_vel = np.array([msg.velocity[12], msg.velocity[13]])
